            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="fulfillments"
                        to="/deliveryFulfillments/fulfillments"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="orderStatuses"
                        to="/orderStatuses/orderStatuses"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="payments"
                        to="/paymentProcessings/payments"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: '주문', 
                description: '주문에 대한 정보를 관리하는 주요 도메인', 
                key: 'orders', 
                route: '/deliveryOrders/orders',
                ImageUrl: '',
            },
            { 
                title: '음식 메뉴 항목', 
                description: '주문에 포함되는 음식 메뉴 항목', 
                key: 'menuItems', 
                route: '/deliveryOrders/menuItems',
                ImageUrl: '',
            },
            { 
                title: '배달 처리', 
                description: '음식 배달을 처리하는 주요 도메인', 
                key: 'fulfillments', 
                route: '/deliveryFulfillments/fulfillments',
                ImageUrl: '',
            },
            { 
                title: '주문 상태', 
                description: '주문의 상태 정보를 관리하는 주요 도메인', 
                key: 'orderStatuses', 
                route: '/orderStatuses/orderStatuses',
                ImageUrl: '',
            },
            { 
                title: '결제', 
                description: '결제 정보를 관리하는 주요 도메인', 
                key: 'payments', 
