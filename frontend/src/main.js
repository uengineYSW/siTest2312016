...
pluralCaseList.push( {plural: "deliveryOrders/orders", pascal: "DeliveryOrderOrder"} )
pluralCaseList.push( {plural: "deliveryOrders/menuItems", pascal: "DeliveryOrderMenuItem"} )

pluralCaseList.push( {plural: "deliveryFulfillments/fulfillments", pascal: "DeliveryFulfillmentFulfillment"} )

pluralCaseList.push( {plural: "orderStatuses/orderStatuses", pascal: "OrderStatusOrderStatus"} )

pluralCaseList.push( {plural: "paymentProcessings/payments", pascal: "PaymentProcessingPayment"} )
