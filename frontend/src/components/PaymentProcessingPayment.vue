<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text>
            ...
            <boolean offline label="완료 여부" v-model="value.isCompleted" :editMode="editMode" @change="change"/>
        </v-card-text>
        ...
        <v-card-actions>
            ...
            <v-btn
                ...
                color="primary"
                text
                @click="openCompletePayment"
            >
                CompletePayment
            </v-btn>
            <v-dialog v-model="completePaymentDiagram" width="500">
                <CompletePaymentCommand
                    @closeDialog="closeCompletePayment"
...
<script>
	...
	async created() {
        ...
        methods: {
            ...
            openCompletePayment() {
                this.completePaymentDiagram = true;
            },
            closeCompletePayment() {
                this.completePaymentDiagram = false;
            },
        },
    }
</script>
